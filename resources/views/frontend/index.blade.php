...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-9 text-center">
            ...
            <hr>
            <h3 class="title text-primary">Bénéficier de nos services RH en ligne</p>
            <hr>
            {{-- Example --}}
            <div class="py-3">
                <!-- Row  -->
                <div class="row">
                    <!-- Column -->
                    <div class="col-md-6">
                        <a href="{{ route('frontend.imputation.index') }}" class="card border-1 card-shadow mb-4 bg-primary">
                            <div class="card-body d-flex">
                                <div class="mr-4 align-self-center display-3">
                    ...
                    <!-- Column -->
                    <div class="col-md-6">
                        <a href="#" class="d-block card border-0 card-shadow mb-4 bg-primary">
                            <div class="card-body d-flex">
                                <div class="mr-4 align-self-center display-3">
